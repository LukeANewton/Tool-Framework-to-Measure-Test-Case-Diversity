...
public class StateSequenceTest {
    ...
    private final String[] eventsFromTestCase = new String[]{"OffProtected", "StoppedProtected", "PlayingProtected", "PausedProtected", "xxxPlayingProtected"};

    @Before
    public void setUp() throws InvalidFormatException {
        d = new StateSequence(testcase);
    }
    ...
    public void testGetDescription() {
        assertEquals(d.getDescription(),
                "reads in a dash-separated list of alternating events and states, but only stores the states");
    }
}
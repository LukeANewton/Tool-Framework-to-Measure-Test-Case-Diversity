...
public class ConfigTest {
        ...
        private String testJson = "{\n" +
                ...
                "  \"comparisonMethodLocation\": \"com.compare.metrics.comparison.\",\n" +
                "  \"dataRepresentation\": \"CSV\",\n" +
                "  \"dataRepresentationLocation\": \"com.compare.data_representation\",\n" +
                "  \"delimiter\": \"\n\",\n" +
                "  \"aggregationMethod\": \"\",\n" +
                "  \"aggregationMethodLocation\": \"com.compare.metrics.aggregation.\",\n" +
                "  \"numThreads\":  3,\n" +
    ...
    /*these are left here in case this is the only record of code that reads/write JSON, but these are not proper tests:
        ...
        */
        ...
        @Test
        /**test the getter for location of comparison com.compare.metrics*/
        public void getComparisonMethodLocation() {
                assertEquals(config.getComparisonMethodLocation(), "com.compare.metrics.comparison.");
        }

        @Test
        /**test the setter for location of comparison com.compare.metrics*/
        ...
        public void getAggregationMethodLocation() {
                assertEquals(config.getAggregationMethodLocation(), "com.compare.metrics.aggregation.");
        }

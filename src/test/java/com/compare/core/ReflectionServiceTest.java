...
public class ReflectionServiceTest {
    ...
    public void testReflectNoArgsConstructor() throws InvalidFormatException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        String classPath = "com.compare.metrics.comparison.CommonElements";
        String implementedInterface = "com.compare.metrics.comparison.PairwiseComparisonStrategy";
    ...
    public void testInvalidPathFormatNoArgs() {
        ...
        implementedInterface = "com.compare.metrics.comparison.PairwiseComparisonStrategy";
        ...
        classPath = "com.compare.metrics.comparison.CommonElements";
        implementedInterface = "com.compare.metrics.comparison/PairwiseComparisonStrategy";
        try {
            reflector.loadClass(classPath, implementedInterface);
            fail();
    ...
    public void testClassNotClass() throws IllegalAccessException, InvocationTargetException, InvalidFormatException,
        ...
        String classPath = "com.compare.metrics.comparison.PairwiseComparisonStrategy";
        String implementedInterface = "com.compare.metrics.comparison.PairwiseComparisonStrategy";
        reflector.loadClass(classPath, implementedInterface);
    }
    ...
    public void testInterfaceNotInterface() throws IllegalAccessException, InvocationTargetException, InvalidFormatException,
            InstantiationException, NoSuchMethodException, ClassNotFoundException {
        String classPath = "com.compare.metrics.comparison.CommonElements";
        String implementedInterface = "com.compare.metrics.comparison.CommonElements";
        reflector.loadClass(classPath, implementedInterface);
    }
    ...
    public void testSearchPackage() {
        try {
            Object[] list = reflector.searchPackage("com.compare.metrics.comparison", "com.compare.metrics.comparison.PairwiseComparisonStrategy");
    ...
    public void testSearchPackageWithNonClassFile() {
        //create file
        File file = new File("target/classes/com.compare.metrics/comparison/banana");
        try {
            file.createNewFile();
        } catch (Exception e) {
            fail();

...
import com.compare.model.CompareDTO;
import com.compare.model.ConfigDTO;
import com.compare.model.DataTransferObject;
import com.compare.model.HelpDTO;
import com.compare.model.HelpType;
...
public class InputParser {
	...
	private DataTransferObject parseHelpCommand(List<String> tokens) throws InvalidCommandException{
		...
		if (tokens.size() == 0) { //the help command contained only "help"
			...
			if(tokens.get(0).equals(DIVERISTY_METRIC_FLAG)) { //need to provide list of diversity com.compare.metrics

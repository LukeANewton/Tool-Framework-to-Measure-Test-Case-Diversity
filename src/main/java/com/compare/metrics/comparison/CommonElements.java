...
/**
 * A pairwise comparison com.compare.metrics which counts the number of elements in a pair of test cases that have the same values and are in the same positions
 *
 * @author luke
 *
 */
